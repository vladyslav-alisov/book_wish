...
extension AuthorEntityByIndex on IsarCollection<AuthorEntity> {
  Future<AuthorEntity?> getByName(String name) {
    return getByIndex(r'name', [name]);
  }

  AuthorEntity? getByNameSync(String name) {
  ...
  Future<List<AuthorEntity?>> getAllByName(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
    return getAllByIndex(r'name', values);
  }

  List<AuthorEntity?> getAllByNameSync(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
  ...
  Future<Id> putByName(AuthorEntity object) {
    return putByIndex(r'name', object);
  }

  Id putByNameSync(AuthorEntity object, {bool saveLinks = true}) {
    return putByIndexSync(r'name', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByName(List<AuthorEntity> objects) {
    return putAllByIndex(r'name', objects);
  }

  List<Id> putAllByNameSync(List<AuthorEntity> objects,
      {bool saveLinks = true}) {
...
extension AuthorEntityQueryWhere
  ...
  QueryBuilder<AuthorEntity, AuthorEntity, QAfterWhereClause> nameEqualTo(
      String name) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AuthorEntity, AuthorEntity, QAfterWhereClause> nameNotEqualTo(
      String name) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
